...
public final class Const {
     ...
     *请求属性键值：当前用户标识
     */
    public static final String REQ_CUR_USER_ID = "REQ_USER_ID";

    /**
     *请求属性键值：当前用户名称
     */
    public static final String REQ_CUR_USER_NAME = "REQ_USER_NAME";

    /**
     *请求属性键值：当前机构标识
     */
    public static final String REQ_CUR_ORG_ID = "REQ_ORG_ID";

    /**
     *请求属性键值：当前角色名称
     */
    public static final String REQ_CUR_ROLE_CODE = "REQ_ROLE_CODE";
